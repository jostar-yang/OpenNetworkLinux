...
static char* ipmi_devfiles__[] =  /* must map with onlp_thermal_id */
{
    NULL,
    NULL,                  /* CPU_CORE files */
    "/sys/devices/platform/asxvolt16b_thermal/temp1_input",
    "/sys/devices/platform/asxvolt16b_thermal/temp2_input",
    "/sys/devices/platform/asxvolt16b_thermal/temp3_input",
    "/sys/devices/platform/asxvolt16b_thermal/temp4_input",
    "/sys/devices/platform/asxvolt16b_psu/psu1_temp1_input",
    "/sys/devices/platform/asxvolt16b_psu/psu2_temp1_input",
};
