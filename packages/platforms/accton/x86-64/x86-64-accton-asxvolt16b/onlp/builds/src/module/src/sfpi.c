...
#include "x86_64_accton_asxvolt16b_log.h"

#define PORT_EEPROM_FORMAT              "/sys/devices/platform/asxvolt16b_sfp/module_eeprom_%d"
#define MODULE_PRESENT_FORMAT		    "/sys/devices/platform/asxvolt16b_sfp/module_present_%d"
#define MODULE_RXLOS_FORMAT             "/sys/devices/platform/asxvolt16b_sfp/module_rx_los_%d"
#define MODULE_TXFAULT_FORMAT           "/sys/devices/platform/asxvolt16b_sfp/module_tx_fault_%d"
#define MODULE_TXDISABLE_FORMAT         "/sys/devices/platform/asxvolt16b_sfp/module_tx_disable_%d"
#define MODULE_PRESENT_ALL_ATTR	        "/sys/devices/platform/asxvolt16b_sfp/module_present_all"
#define MODULE_RXLOS_ALL_ATTR           "/sys/devices/platform/asxvolt16b_sfp/module_rxlos_all"
